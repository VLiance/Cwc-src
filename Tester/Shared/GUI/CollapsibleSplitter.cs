...
namespace NJFLib.Controls
{
	...
	[System.ComponentModel.Designer(typeof (CollapsibleSplitterDesigner))]
	public class CollapsibleSplitter : System.Windows.Forms.Splitter
	{
		...
		private bool hot;
		private System.Drawing.Color hotColor = CalculateColor(System.Drawing.SystemColors.Highlight, System.Drawing.SystemColors.Window, 70);
		...
		/// </summary>
		[System.ComponentModel.Bindable(true), System.ComponentModel.Category("Collapsing Options"), System.ComponentModel.DefaultValue("False"),
			System.ComponentModel.Description("The initial state of the Splitter. Set to True if the control to hide is not visible by default")]
		...
		/// </summary>
		[System.ComponentModel.Bindable(true), System.ComponentModel.Category("Collapsing Options"), System.ComponentModel.DefaultValue(""),
		...
		/// </summary>
		[System.ComponentModel.Bindable(true), System.ComponentModel.Category("Collapsing Options"), System.ComponentModel.DefaultValue("True"),
			System.ComponentModel.Description("Determines if the collapse and expanding actions will be animated")]
		...
		/// </summary>
		[System.ComponentModel.Bindable(true), System.ComponentModel.Category("Collapsing Options"), System.ComponentModel.DefaultValue("20"),
			System.ComponentModel.Description("The delay in millisenconds between animation steps")]
		...
		/// </summary>
		[System.ComponentModel.Bindable(true), System.ComponentModel.Category("Collapsing Options"), System.ComponentModel.DefaultValue("20"),
			System.ComponentModel.Description("The amount of pixels moved in each animation step")]
		...
		/// </summary>
		[System.ComponentModel.Bindable(true), System.ComponentModel.Category("Collapsing Options"), System.ComponentModel.DefaultValue("False"),
			System.ComponentModel.Description("When true the entire parent form will be expanded and collapsed, otherwise just the contol to expand will be changed")]
		...
		/// </summary>
		[System.ComponentModel.Bindable(true), System.ComponentModel.Category("Collapsing Options"), System.ComponentModel.DefaultValue("VisualStyles.XP"),
			System.ComponentModel.Description("The visual style that will be painted on the control")]
		...
		/// </summary>
		[System.ComponentModel.Bindable(true), System.ComponentModel.Category("Collapsing Options"), System.ComponentModel.DefaultValue("System.Windows.Forms.Border3DStyle.Flat"),
			System.ComponentModel.Description("An optional border style to paint on the control. Set to Flat for no border")]
       ...
       public void fSetTheme() {
		...
		private void OnMouseMove(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			...
			else
			{
				...
				//this.Cursor = System.Windows.Forms.Cursors.Default; //Cw- Laggg
		...
		private System.Drawing.Point[] ArrowPointArray(int x, int y)
		{
			...
			if (controlToHide != null)
			{
				...
				if (
					(this.Dock == System.Windows.Forms.DockStyle.Right && controlToHide.Visible)
						|| (this.Dock == System.Windows.Forms.DockStyle.Left && !controlToHide.Visible)
					)
				{
					// right arrow
					point[0] = new System.Drawing.Point(x, y);
					point[1] = new System.Drawing.Point(x + 3, y + 3);
					point[2] = new System.Drawing.Point(x, y + 6);
				}
				else if (
					(this.Dock == System.Windows.Forms.DockStyle.Right && !controlToHide.Visible)
						|| (this.Dock == System.Windows.Forms.DockStyle.Left && controlToHide.Visible)
				...
				{
					// left arrow
					point[0] = new System.Drawing.Point(x + 3, y);
					point[1] = new System.Drawing.Point(x, y + 3);
					point[2] = new System.Drawing.Point(x + 3, y + 6);
				}

					// Up/Down arrows added in v1.2

				else if (
					(this.Dock == System.Windows.Forms.DockStyle.Top && controlToHide.Visible)
						|| (this.Dock == System.Windows.Forms.DockStyle.Bottom && !controlToHide.Visible)
					)
				{
					// up arrow
					point[0] = new System.Drawing.Point(x + 3, y);
					point[1] = new System.Drawing.Point(x + 6, y + 4);
					point[2] = new System.Drawing.Point(x, y + 4);
				}
				else if (
					(this.Dock == System.Windows.Forms.DockStyle.Top && !controlToHide.Visible)
						|| (this.Dock == System.Windows.Forms.DockStyle.Bottom && controlToHide.Visible)
					)
				{
					// down arrow
					point[0] = new System.Drawing.Point(x, y);
					point[1] = new System.Drawing.Point(x + 6, y);
					point[2] = new System.Drawing.Point(x + 3, y + 3);
				}
			}
		...
		private static System.Drawing.Color CalculateColor(System.Drawing.Color front, System.Drawing.Color back, int alpha)
		{
			// solid color obtained as a result of alpha-blending

			System.Drawing.Color frontColor = System.Drawing.Color.FromArgb(255, front);
			System.Drawing.Color backColor = System.Drawing.Color.FromArgb(255, back);
			...
			return System.Drawing.Color.FromArgb(255, newRed, newGreen, newBlue);
		}
