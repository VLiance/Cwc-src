...
namespace Raccoom.Windows.Forms
{
    ...
    public class TreeViewFolderBrowser : System.Windows.Forms.TreeView
    {
        ...
        //    this.CheckBoxBehaviorMode = CheckBoxBehaviorMode.SingleChecked;
            this.CheckBoxBehaviorMode = CheckBoxBehaviorMode.None;
        ...
        /// </summary>
        public virtual void Populate(bool clear)
        {
            Populate(null,clear);
        }
        ...
        public virtual void Populate(string selectedNodePath, bool clear){
    ...
    //CW+-----------------
    internal static class NativeMethods { //CW+ for DoubleBuffering
        // Pinvoke:
