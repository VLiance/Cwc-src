...
namespace Raccoom.Windows.Forms
{
	...
	public class TreeStrategyFolderBrowserProvider : TreeStrategySystemFolderBrowserProviderBase
	{
        ...
        public string sCustomRootDir = ""; //Cw+
        public TreeNodePath oParentNode = null; //Cw+
		#endregion
        ...
        public void fClear(){//Cw+
             Helper.TreeView.Nodes.Clear();
        }
		...
		public override void RequestRootNode()
		{
            ...
            if (sCustomRootDir == "") {  //CW+
			    switch (RootFolder)
			    {
                 ...
                 sCustomRootDir = sCustomRootDir.Replace('/','\\');
                if(sCustomRootDir[sCustomRootDir.Length-1] == '\\'){
                     sCustomRootDir = sCustomRootDir.Substring(0,sCustomRootDir.Length-1);
                 }
    
                rootNodeCollection = Helper.TreeView.Nodes;
                driveRootNodeCollection = rootNodeCollection;
                // create root node with specified SpecialFolder
                this.CreateTreeNode(oParentNode, System.IO.Path.GetFileName(sCustomRootDir), sCustomRootDir, false, true, false);
               //fAddRootNode(oParentNode);
                oParentNode = null;
                populateDrives = false;
            }
