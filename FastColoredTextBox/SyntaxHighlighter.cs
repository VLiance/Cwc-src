...
namespace FastColoredTextBoxNS
{
    public class SyntaxHighlighter : IDisposable
    {
        ...
        public readonly Style BlueBoldStyle = new TextStyle(Brushes.DarkBlue, null, FontStyle.Bold);
        public readonly Style BlueStyle = new TextStyle( new SolidBrush( Color.FromArgb(108,169,252)), null, FontStyle.Regular);
